...
const AddNewUser = () => {
  ...
  const [getUploadedUrl, setGetUploadedUrl] = useState("");
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      values["profile_image"] = profile;
      values["banner_image"] = banner;
  ...
  const selectFileHandler = async (e) => {
    ...
    // await uploadFileDetails(formData)
    //   .then((response) => {
    //     console.log(response, "response data");
    //     setGetUploadedUrl(response?.data[0]?.fileUri);
    //   })
    //   .catch((err) => {
    //     console.log(err);
    //   });
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Button variant="contained" component="label">
              ...
              <input
                ...
                onBlur={selectFileHandler}
                // value={formik.setFieldValue("profile_image", profile)}
              />
            </Button>
          </Grid>
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Button variant="contained" component="label">
              ...
              <input
                ...
                onChange={selectFileHandler}
                onBlur={selectFileHandler}
                // value={formik.setFieldValue("banner_image", banner)}
              />
            </Button>
          </Grid>
